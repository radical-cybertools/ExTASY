...
if __name__ =='__main__':
    ...
    max_alive_neighbors = sys.argv[8]
    max_dead_neighbors = sys.argv[9]
    ...
    os.system('python reweighting.py -c %s -n %s -s %s -w %s -o %s --max_alive_neighbors=%s --max_dead_neighbors=%s' % (md_output_file,nearest_neighbor_file,num_clone_files,w_file,outgrofile_name,max_alive_neighbors,Kconfig.max_dead_neighbors))
