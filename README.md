...
* The workload configuration file defines the Amber/CoCo workload itself. The configuration file given in this example is strictly meant for the gromacs-lsdmap usecase only.
